...
```text
Discord：<@123456789012345678>｜ユーザー名：ユーザー名｜PC名：PC名
Discord：登録されていません｜ユーザー名：ユーザー名｜PC名：PC名未登録
...
- DiscordユーザーIDが未登録または形式不正なら `Discord：登録されていません` を出す。
- PC名が未登録なら `PC名：PC名未登録` を出す。
